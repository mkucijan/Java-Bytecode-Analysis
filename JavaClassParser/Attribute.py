...
from JavaClassParser import ByteToHex, ByteToDec
from JavaClassParser.ExceptionInfo import ExceptionInfo
from JavaClassParser import InnerClassAccessFlags
...
class Attribute(object):
    ...
    def getParser(attrName):
        ...
        if attrName in parserDict:
            return parserDict[str(attrName)]
        else:
            return None
...
import JavaClassParser.ByteCode as bc
...
class CodeAttribute(Attribute):
    ...
    def addAttribute(self, attribute):
        if attribute.name is LINE_NUMBER_TABLE_NAME:
            self.lineNumberTable = attribute
